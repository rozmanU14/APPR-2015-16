...
Njavečji relativni prirast je v Dol pri Ljublajni, najmanjši pa v Dravogradu.
...
```
ggplot(tabela %>% filter(kraj %in% c("Ljubljana","Maribor","Dol pri Ljubljani","Dravograd")),
+        aes(x = leto, y = naravni.prirast.na.1000.prebivalcev, group = kraj, color = kraj)) +
+     geom_line()
...
Razpredelnica prikazuje števlo umrlih moških in žensk v letih pod 2010 do 2014
```{r razpredelnica4, echo=FALSE}
kable(head(umrli))
```

```{r graf7, echo=FALSE,fig.align='center',fig.cap='urmlivosr 2011'}
