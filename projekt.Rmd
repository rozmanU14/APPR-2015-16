...
```
Graf predstavlja napoved umrlivost do leta 2020. Za boljšo napoved sem iz statističnega urada dodatno uvozila podatke za Slovenijo od leta 1997 naprej. Iz grafa je razvidno, da bo umlivost po letih padala.

```{r graf10, echo=FALSE,fig.align='center',fig.cap='Napoved umrljivosti', warning=FALSE}

letoSlo<-tabelaSlo$leto
plot(letoSlo,tabelaSlo$umrlivost.na.1000, xlim=c(1997,2020),ylim=c(-50,50),
     xlab="Leto",ylab="število umrlih na 1000 prebivalcev",
     main="Napoved umrlivosti za Slovenijo",pch=20,col="blue",type="p",lwd=3.5)
...
Graf prikazuje napoved umrlivosti po letih od 1997 do 2020. Iz grafa je razvidno, da je umrlivost pribljižno konstantna.
...
plot(letoLj,tabelaLjubljana$prirast, xlim=c(1995,2020),ylim=c(-50,100),
