...
```{r graf 9, echo=FALSE,fig.align='center',fig.cap='Napoved prirasta za Slovenijo', warning=FALSE}
...
```{r graf 10, echo=FALSE,fig.align='center',fig.cap='napoved rasti rodnosti', warning=FALSE}
...
```{r graf 11, echo=FALSE,fig.align='center',fig.cap='Napoved umrlivosti', warning=FALSE}
