...
zem3 <- zem2 + geom_text(data = obcine@data %>% filter(OB_TIP == "D"),
                         ...
                         size = 3, vjust = 2) #velikost pisave,imena napise pod pikami(ker je pozitiven)
print(zem3)
...
map2 <- ggplot() + geom_polygon(data = usa.cont,
                   ...
                   guides(fill = guide_legend("Volitve 2012"))  #legenda
print(map2)
